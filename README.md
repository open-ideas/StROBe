...
**Konduto** is an open web tool developed at the [KU Leuven Building Physics Section](http://bwk.kuleuven.be/bwf/) 
...
Primarily conceived as a tool for scientific researchers, **Konduto** aims at providing missing boundary conditions
...
**Konduto** is also highly customizable and extensible, accepting model changes or extensions defined by users. 
For more information on the implementation, see the [GitHub Wiki]
(https://github.com/rubenbaetens/ProclivityPy/wiki).

###Dependencies

**Konduto** is implemented in Python and uses the packages Os, Numpy, Random, Time, Datetime and Ast, which are
